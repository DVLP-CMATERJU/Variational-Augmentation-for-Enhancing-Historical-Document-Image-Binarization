import argparse
import os
from synthetic.util import util
import torch
import synthetic.models as models
import synthetic.data as data

PATH = "/media/Reserve_Storage/student_data/intern/intern_1/data/BINARIZATION/new_synth/bicyc"
class BaseOptions():
    def __init__(self):
    ...
    def initialize(self, parser):
        ...
        """
        parser.add_argument('--dataroot', required=False, default=PATH, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--name', type=str, default='dibco', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='/media/Reserve_Storage/student_data/intern/intern_1/data/BINARIZATION/Restoration/code/synthetic/checkpoints', help='models are saved here')
