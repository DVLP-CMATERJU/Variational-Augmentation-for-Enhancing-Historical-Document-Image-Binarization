...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--num_test', type=int, default=13320, help='how many test images to run')
        parser.add_argument('--n_samples', type=int, default=3, help='#samples')
        ...
        parser.add_argument('--aspect_ratio', type=float, default=0.5, help='aspect ratio for the results')
